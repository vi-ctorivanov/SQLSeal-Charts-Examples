...
Some queries use the `now` keyword and a limited timeframe, resulting in graphs that may appear empty or sparsely populated due to no new longs being added.
